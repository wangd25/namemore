...
**Status: In progress.** Phases 7A, 7B, and 7C1 are published and Preview-verified. Phase 7C1 is complete on `codex/phase-7c-draft-review`, including the non-production Supabase migration and exact-source protected Preview. This phase makes the product broadly category-first without allowing unreviewed generation into competitive play.

...
**Status: In progress.** Phases 7A and 7B are published and Preview-verified. Phase 7B is complete on `codex/phase-7b-general-practice`, including the non-production Supabase migration and exact-source protected Preview. This phase makes the product broadly category-first without allowing unreviewed generation into competitive play.

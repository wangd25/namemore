...
**Status: In progress.** Phases 7A–7C5 are published and Preview-verified. Phase 7C5 is complete on `codex/phase-7c5-approved-bank-publishing`, including its non-production Supabase migration and exact-source protected Preview. This phase makes the product broadly category-first without allowing unreviewed generation into competitive play.
